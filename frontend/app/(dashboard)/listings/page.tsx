      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {showForm && (
          <div className="bg-g800 border border-g700 p-6 mb-8">
            <h2 className="font-display font-bold text-white mb-4">Nieuwe listing toevoegen</h2>
            {error && (
            ...
            <form onSubmit={handleAdd} className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="number" value={form.area_m2}
              ...
              <div>
                ...
                <select value={form.energy_label}
              ...
              <div className="col-span-2 flex items-center gap-3">
                <input type="checkbox" id="is_rental" checked={form.is_rental}
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="font-display text-2xl font-bold text-white tracking-tight">Mijn listings</h1>
